...
class OldSaleReportOnlySummary(Report):
    _SERIAL_PATTERN = r'\d+'
    ...
    def __init__(self, working_dir_name, reportTableName, excel_sheet_name):
        ...
        self.SELECTED_COL_IDS = r'E, K, L, N, M, P'
        self.SELECTED_COL_NAMES = ['serialNum', 'sumAmount', 'sumTotal', 'unit', 'importPrice', "supplier"]
    ...
    def getSupplier(self, df, ind):
        return df['supplier'][ind]
