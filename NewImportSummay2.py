...
class NewImportSummay2(Report):
    # 表16 入库单明细汇总
    # 表17
    def __init__(self, working_dir_name, reportTableName, excel_sheet_name):
        super().__init__(working_dir_name, reportTableName, excel_sheet_name)
        self.SELECTED_COL_NAMES = ['serialNum', 'productName', 'importAmount', 'cost', 'importPrice']
        # self.SELECTED_COL_IDS = r'C,E,O,P,R'  # 表16
        self.SELECTED_COL_IDS = r'D,E,O,P,Q'  # 表17
